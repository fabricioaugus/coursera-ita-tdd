...
public class CamelCase{
	...
	public static List<String> converterCamelCase(String texto){
		if(texto.matches("^[0-9].*"))
			throw new ConvertException("Palavra inválida: Não pode começar com números");
		if(!texto.matches("(\\w)*"))
			throw new ConvertException("Palavra inválida: Não pode conter caractere especial");
